            ...
            switch (_context.prev = _context.next) {
              case 0:
                navigator.mediaDevices.getUserMedia({
                  ...
                  return UIkit.notification('Este dispositivo no dispone de un microfono, por favor habilita uno, y activalo en tu navegador para que puedas usar la herramienta de audio', {
                    pos: "top-right",
                    status: "danger",
                    timeout: 5000
                  });
                ...
                navigator.permissions.query({
                  ...
                  permission.state === 'denied' && UIkit.notification('Para grabar un audio es necesario activar el microfono.', {
                    pos: "top-right",
                    status: "danger",
                    timeout: 5000
                  });
